...
/*import 'file:///C:/Users/DARSHAN/AndroidStudioProjects/leadmanagement/lib/nadirlib/lib/ProdGroups/group1.dart';
import 'file:///C:/Users/DARSHAN/AndroidStudioProjects/leadmanagement/lib/nadirlib/lib/ProductGroups/group1.dart';*/
//import 'package:file//home/nadir/AndroidStudioProjects/leadmanagement/lib/nadirlib/lib/ProdGroups/group1.dart';
import 'package:file//home/nadir/AndroidStudioProjects/leadmanagement/lib/nadirlib/lib/ProductGroups/group1.dart';

class ProdVerticalList extends StatelessWidget {
  static const String _title = ' Add Groups';
//  List<Name> name;
  List name;

  ProdVerticalList({Key key, @required this.name}) /*: super(key: key)*/
  ;
    ...
    return Padding(padding: const EdgeInsets.all(2.0),
        child: InkWell(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ProductGroup1()),
            );
          },
